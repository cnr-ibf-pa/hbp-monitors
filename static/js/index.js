...
//    redirect_uri: "https://bspmonitors.cineca.it/hpc-monitor",
    redirect_uri: "http://localhost:8000/hpc-monitor",
...
//                URL = "https://bspmonitors.cineca.it/" + hpcContext.id.toLowerCase() + "/check";
                URL = "http://localhost:8000/hpc-monitor/" + hpcContext.id.toLowerCase() + '/check';
                METHOD = "GET";
            } else {
